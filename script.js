...
// Extra
// you ave an array of objects that contains name,age and gender of different students. Your task is to return the total ages of male and female students that are not older than 25, i.e people that are aged 25 or less.
let extra = [
...
const newFilter2 = extra.filter(function (el){
    return el.age <= 25
})
console.log(newFilter2)  // correct!!
